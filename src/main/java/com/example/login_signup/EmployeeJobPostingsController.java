...
public class EmployeeJobPostingsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resource) {
        button_back.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try{
                    root = FXMLLoader.load(DBUtils.class.getResource("loggedin.fxml"));
                }
                catch(IOException e)
                {
                    e.printStackTrace();
...
//        String jobViewQuery = "SELECT company_name, job_title, job_description, location, qualification, salary_range, post_date  FROM jobpost";
        try {
            ...
            preparedStatement = connection.prepareStatement("SELECT company_name, job_title, job_description, location, qualification, salary_range, post_date, job_post_id  FROM jobpost");
...
//                jobSearchModelObservableList.add(new JobSearchModel(queryOutput.getInt("")))
    ...
    public void onRowSelected(MouseEvent mouseEvent){
        ...
        DBUtils.changeScene_mouse(mouseEvent,"EmployeeUploadPDF.fxml", null, null, null);

        System.out.println("Job Postings Controller theke bolchi \n");
