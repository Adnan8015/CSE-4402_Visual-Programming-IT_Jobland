...
//
//public class EmployerJobListController {
//}
package com.example.login_signup;
...
public class EmployerJobListController implements Initializable {
//    public static String jobPostingID;
    ...
    @FXML
    public TableColumn<JobSearchModel, String> col_employeeName;

//    @FXML
//    public TableColumn<JobSearchModel,String> col_jobPostID;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resource) {
        button_back.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try{
                    root = FXMLLoader.load(DBUtils.class.getResource("EmployerWelcome.fxml"));
                }
                catch(IOException e)
                {
                    e.printStackTrace();
...
//        String jobViewQuery = "SELECT company_name, job_title, job_description, location, qualification, salary_range, post_date  FROM jobpost";
        try {
            ...
            preparedStatement = connection.prepareStatement("SELECT company_name, job_title, job_description, location, qualification, salary_range, post_date, employer_name , job_post_id FROM jobpost WHERE employer_name = ?");
            preparedStatement.setString(1, EmployerFirstPageController.USERNAME);
...
//                jobSearchModelObservableList.add(new JobSearchModel(queryOutput.getInt("")))
                ...
                String queryEmployerName = queryOutput.getString("employer_name");
                String queryJobPostID = String.valueOf(queryOutput.getInt("job_post_id"));
                // Populating the observable list
                jobSearchModelObservableList.add(new JobSearchModel(null, null, queryCompanyName, queryJobTitle, queryJobDesc, queryLocation, queryQualifications, querySalary, queryDate, queryEmployerName, queryJobPostID));
            }
            ...
            col_employeeName.setCellValueFactory(new PropertyValueFactory<>("employee_name"));
    ...
    public void onRowSelected(MouseEvent mouseEvent){
        ...
        DBUtils.changeScene_mouse(mouseEvent,"EmployerApplicants&PDF.fxml", null, null, null);
